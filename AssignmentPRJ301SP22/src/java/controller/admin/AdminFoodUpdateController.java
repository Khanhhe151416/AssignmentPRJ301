...
public class AdminFoodUpdateController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        food f = fDB.getfood(id);
        TypeFoodDBConext tDB = new TypeFoodDBConext();
        List<TypeFood> tfs = tDB.getTypeFoods();
        request.setAttribute("tfs", tfs);
        request.setAttribute("food", f);
        request.getRequestDispatcher("../../view/admin/foodUpdate.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        tf.setId(Integer.parseInt(request.getParameter("type")));
        f.setType(tf);
        FoodDBContext fDB = new FoodDBContext();
        fDB.update(f);
