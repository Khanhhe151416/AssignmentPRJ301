 ...
 * @author doan7
 */
public class AdminFoodInsertController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<TypeFood> tf = tDB.getTypeFoods();
        request.setAttribute("tfs", tf);
        request.getRequestDispatcher("../../view/food/insert.jsp").forward(request, response);
    }
